...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey }, "a", function () awful.util.spawn( terminal.." -e nvim" ) end,
    ...
    awful.key({ modkey, altkey }, "c", function () awful.util.spawn( editorgui ) end,
        {description = "launch "..editorgui , group = "gui apps" }),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey }, "c", function () awful.spawn.with_shell("c | xsel -i -b") end,
